...
export default function PokeCadenaEvo({ shiny, primeraEvolucion, segundaEvolucion, terceraEvolucion, mayuscula, setPokemon }) {
    ...
    //Función para que al clicar en un pokemon te devuelva arriba
    const volverArriba = () => {
        window.scrollTo({
          top: 0,
          behavior: 'smooth'
    ...
    if (segundaEvolucion.length == 1 && terceraEvolucion.length == 1) {
        return (
            <div className="text-center py-1">
                ...
                <div className="pokeEvo d-inline-flex" onClick={() => { setPokemon(primeraEvolucion[0]); volverArriba() } } >
                    <PokeImage pokemon={primeraEvolucion[0]} shiny={shiny} />
                </div>
                <p><span className='fw-bold'>{"#" + primeraEvolucion[0].id}</span> {mayuscula(primeraEvolucion[0].name)}</p>
                ...
                <div className="pokeEvo d-inline-flex" onClick={() => { setPokemon(segundaEvolucion[0][0]); volverArriba() } } >
                ...
                <div className="pokeEvo d-inline-flex" onClick={() => { setPokemon(terceraEvolucion[0][0]); volverArriba() }} >
    ...
    //Si el pokemon tiene variantes evolutivas en la segunda fase de evolución o no tiene tercera evolución
                    ...
                    segundaEvolucion.map((segundaEvo) => {
                        return (
                            <div key={primeraEvolucion[0].name + segundaEvo[0].name} className="text-center py-1 ">
                                ...
                                <div className="pokeEvo d-inline-flex" onClick={ () => { setPokemon(segundaEvo[0]); volverArriba() }} >
                    ...
                    terceraEvolucion.map((terceraEvo) => {
                        return (
                            <div key={primeraEvolucion[0].name + segundaEvolucion[0].name + terceraEvo[0].name} className="text-center pb-3">
                                ...
                                <div className="pokeEvo d-inline-flex" onClick={() => { setPokemon(terceraEvo[0]); volverArriba() }} >
